/**
 * Módulo de onboarding (barrel) para manter API pública compatível.
 */

export { Profile } from '../../features/profile.js';
export { OnboardingBanner } from './onboarding/onboardingBanner.js';
export { SavedHighlight } from './onboarding/savedHighlight.js';
