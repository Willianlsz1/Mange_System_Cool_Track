/**
 * CoolTrack Pro - Dashboard / equipCardMini
 * Miniatura do card de equipamento usada no grid "Críticos" do dashboard.
 * (Layout específico do dashboard; não compartilha com equipCardHtml da lista.)
 */
...
import { calcHealthScore, getHealthClass } from './metrics.js';
...
export function equipCardMini(eq) {
